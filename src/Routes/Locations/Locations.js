...
const Locations=()=>{
    ...
    useEffect(()=>{
    fetch(`https://rickandmortyapi.com/api/location/?page=${page}&type=${typeloc}&dimension=${dimension}`)
    ...
    }, [page, typeloc, dimension])
    return(
        <div className='Locations'>
             <Header/>
            <div className='content__Locations'>
            <h3>Locations</h3>
            <FiltersLocation typeloc={typeloc} setTypeloc={setTypeloc} dimension={dimension} setDimension={setDimension}/>
